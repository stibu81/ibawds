...
[![Codecov test coverage](https://codecov.io/gh/stibu81/ibawds/branch/master/graph/badge.svg)](https://app.codecov.io/gh/stibu81/ibawds?branch=master)
<!-- badges: end -->
...
possible also for non-admin users.
...
[link](https://www.rstudio.com/products/rstudio/download/#download). Usually,
it is easiest to use the appropriate installer for your operating system,
however, if you don't have admin access on your computer, you should instead
download the appropriate zip-file / tarball.
